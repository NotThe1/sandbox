...
/**
 * A <code>XSpinnerXX</code> is a component that displays a single value from
 ...
 * @since 1.4
 */
public class XSpinnerXX extends JComponent
{
  /**
   * The base class for the editor used by the {@link XSpinnerXX} component.
    ...
    implements ChangeListener, PropertyChangeListener, LayoutManager
  {
     ...
     *
     * @param spinner the <code>XSpinnerXX</code> associated with this editor
     */
    public DefaultEditor(XSpinnerXX spinner)
    {
      super();
      setLayout(this);
    ...
    /**
     * Returns the <code>XSpinnerXX</code> component that the editor is assigned
     * to.
     *
     * @return The spinner that the editor is assigned to.
     */
    public XSpinnerXX getSpinner()
    {
      return spinner;
    }
     ...
     */
    public void dismiss(XSpinnerXX spinner)
    {
    ...
    /**
     * Receives notification of changes in the state of the {@link XSpinnerXX}
   ...
   * a {@link XSpinnerXX}.
   *
   * @see XSpinnerXX#createEditor(SpinnerModel)
   */
  public static class NumberEditor extends DefaultEditor
  {
     ...
     */
    public NumberEditor(XSpinnerXX spinner)
    {
      super(spinner);
     ...
     */
    public NumberEditor(XSpinnerXX spinner, String decimalFormatPattern)
    {
      super(spinner);
    ...
    /**
     * Returns the model used by the editor's {@link XSpinnerXX} component,
  ...
  /**
   * A <code>XSpinnerXX</code> editor used for the {@link SpinnerListModel}.
  ...
  public static class ListEditor extends DefaultEditor
  {
     ...
     */
    public ListEditor(XSpinnerXX spinner)
    {
      super(spinner);
    }
  ...
  /**
   * An editor class for a <code>XSpinnerXX</code> that is used
  ...
  public static class DateEditor extends DefaultEditor
  {
     ...
     * <code>XSpinnerXX</code>.
     *
     * @param spinner the <code>XSpinnerXX</code> for which to
     *     create a <code>DateEditor</code> instance
     */
    public DateEditor(XSpinnerXX spinner)
    {
      super(spinner);
    ...
    /**
     * Creates a new instance of DateEditor for the specified
     * <code>XSpinnerXX</code> using the specified date format
     * pattern.
     *
     * @param spinner the <code>XSpinnerXX</code> for which to
     *     create a <code>DateEditor</code> instance
     ...
     */
    public DateEditor(XSpinnerXX spinner, String dateFormatPattern)
    {
      super(spinner);
   ...
   * to the {@link XSpinnerXX}'s listeners.
   */
  ...
  /**
   * Creates a new <code>XSpinnerXX</code> with default instance of
  ...
  /**
   * Creates a new <code>XSpinnerXX with the specified model.  The
   ...
   */
  public XSpinnerXX(SpinnerModel model)
  {
    this.model = model;
  ...
  /**
   * If the editor is <code>XSpinnerXX.DefaultEditor</code>, then forwards the
  ...
  /**
   * Returns the model used by the {@link XSpinnerXX} component.
   *
   * @return The model.
   *
 ...
 //   super.setUI(ui);
   ...
   * added to this <code>XSpinnerXX</code>
   */
