...
public class RegexTest {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegexTest window = new RegexTest();
	...
	private void initialize() {
		...
		frmTemplate.setTitle("RegexTest");
		...
		gbl_panelLeft.columnWidths = new int[] { 100, 0, 0 };
		...
		panelLeft.add(lblSource, gbc_lblSource);
		...
		panelLeft.add(textField, gbc_textField);
		...
		panelLeft.add(textField_1, gbc_textField_1);
