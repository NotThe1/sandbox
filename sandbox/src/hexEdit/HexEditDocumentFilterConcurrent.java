 ...
 *
 */
public class HexEditDocumentFilterConcurrent extends DocumentFilter {
	...
	public HexEditDocumentFilterConcurrent(StyledDocument doc, HexEditMetrics hexMetrics, byte[] sourceData) {
		this.doc = doc;
	...
	public void replace(DocumentFilter.FilterBypass fb, int offset, int length, String text, AttributeSet attrs)
		...
		sourceData[getSourceIndex(offset, sourceColumn)]= newValue;
