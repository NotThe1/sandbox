...
public class WalkTheParser {
	...
	Matcher matcher;
	Pattern patLIT_A =  Pattern.compile("A");
	Pattern patLIT_HL =  Pattern.compile("HL");
	Pattern patIND_XYd =  Pattern.compile("\\(I[X|Y]\\+");
	Pattern patR8M =  Pattern.compile("(\\(HL\\))|(\\b[A|B|C|D|E|H|L|M]\\b)");
	Pattern patEXP =  Pattern.compile(".");
	Pattern patR16_SP =  Pattern.compile("BC|DE|HL|SP");
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WalkTheParser window = new WalkTheParser();
...
//		OpCodeNode root = new OpCodeNode(null,"BAD");
//		
//		OpCodeNode arg1 = new OpCodeNode(patLIT_A,"BAD");
//		root.addNode(arg1);
//		OpCodeNode arg2 =new OpCodeNode(patIND_XYd,"ADC_1");
//		arg1.addNode(arg2);
//		 arg2 =new OpCodeNode(patR8M,"ADC_2");
//		arg1.addNode(arg2);
//		 arg2 =new OpCodeNode(patEXP,"ADC_3");
//		arg1.addNode(arg2);
//		
//		 arg1 = new OpCodeNode(patLIT_HL,"BAD");
//		root.addNode(arg1);
//		 arg2 =new OpCodeNode(patR16_SP,"ADC_4");
//		arg1.addNode(arg2);
		
//		String opCodeVar = getSubCode(root);
//			
//		txtLog.append(String.format("opCodeVar = %s%n", opCodeVar));
		

		OpCodeNode root = new OpCodeNode(null,"BAD");
		
		OpCodeNode[] branch = new OpCodeNode[]{new OpCodeNode(patLIT_A,"BAD"),
				new OpCodeNode(patIND_XYd,"ADC_1"),new OpCodeNode(patR8M,"ADC_2"),new OpCodeNode(patEXP,"ADC_3")};
		root.addBranch(branch);
		branch  = new OpCodeNode[]{new OpCodeNode(patLIT_HL,"BAD"),
...
public static  final String  BAD_OP_CODE = "Bad opCode";

	private String getSubCode(OpCodeNode root){
		String source = textField1.getText().trim();
		String opCodeVar = BAD_OP_CODE;
		String s;
		OpCodeNode ocnArg1,ocnArg2;
		while (root.hasNext()){
			ocnArg1 = root.next();
			matcher = ocnArg1.getPattern().matcher(source);
	...
	private void appClose() {
		Preferences myPrefs =  Preferences.userNodeForPackage(WalkTheParser.class).node(this.getClass().getSimpleName());
	...
	private void initialize() {
		...
		frmTemplate.setTitle("Walk the parser");
