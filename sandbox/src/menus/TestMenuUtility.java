...
import myComponents.MenuUtility;
...
public class TestMenuUtility {
	...
	private void doBtnOne() {
		...
		// MenuUtility.addFileItem(mnuTest1, myFile);
		MenuUtility.addStringItem(mnuTest1, "Added Menu Item Button 1");
		MenuUtility.addStringItem(mnuTest1, "Added Another Menu Item");
	}// doBtnOne

	private void doBtnTwo() {
//		File myFile = new File("C:\\Temp");
//		MenuUtility.addFileItem(mnuTest1, myFile, new JRadioButtonMenuItem());
		buttonGroup.add(MenuUtility.addStringItem(mnuTest1, "Added Menu Item Button 2.1",new JRadioButtonMenuItem()));
		buttonGroup.add(MenuUtility.addStringItem(mnuTest1, "Added Menu Item Button 2.2",new JRadioButtonMenuItem()));
		buttonGroup.add(MenuUtility.addStringItem(mnuTest1, "Added Menu Item Button 2.3",new JRadioButtonMenuItem()));

	}// doBtnTwo

	private void doBtnThree() {
		MenuUtility.addStringItem(mnuTest1, "Added Menu Item Button 3",new JRadioButtonMenuItem());

	}// doBtnThree

	private void doBtnFour() {
		for ( int i = 0; i < mnuTest1.getItemCount(); i ++) {
			if (mnuTest1.getItem(i)== null){
				continue;
			}
			if(mnuTest1.getItem(i).getText().equals("Added Menu Item Button 2.2")) {
				mnuTest1.getItem(i).setSelected(true);
			}
		}//
	...
	private void appClose() {
		Preferences myPrefs = Preferences.userNodeForPackage(TestMenuUtility.class)
	...
	private void initialize() {
		...
		mnuTest1 = new JMenu("Test1");
		menuBar.add(mnuTest1);

		JMenuItem mnuTest1Item1 = new JMenuItem("item1.1");
		mnuTest1.add(mnuTest1Item1);

		JMenuItem mnuTest1Item2 = new JMenuItem("item1.2");
		mnuTest1.add(mnuTest1Item2);

		JSeparator separatorFileStart = new JSeparator();
		separatorFileStart.setName(MenuUtility.RECENT_FILES_START);
		mnuTest1.add(separatorFileStart);
		...
		mnuRemoveRecentFiles.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				MenuUtility.clearList(mnuTest1);
			}
		});
		mnuRemoveRecentFiles.setVisible(false);
		mnuTest1.add(mnuRemoveRecentFiles);
