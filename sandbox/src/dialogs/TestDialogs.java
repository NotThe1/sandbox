...
public class TestDialogs {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TestDialogs window = new TestDialogs();
	...
	private void doBtnOne(){
		Dialog1 dialog1 = new Dialog1((Window)frmTemplate);
		System.out.printf("result from dialog1 = %d%n",dialog1.showDialog());
		dialog1 = null;
	}//doBtnOne
	...
	private void appClose() {
		Preferences myPrefs =  Preferences.userNodeForPackage(TestDialogs.class).node(this.getClass().getSimpleName());
	...
	private void initialize() {
		...
		frmTemplate.setTitle("Test Dialog");
